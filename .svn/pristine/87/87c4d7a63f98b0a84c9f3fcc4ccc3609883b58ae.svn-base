...
public abstract class JunctionModel implements Timed {
	...
	startLanesID = new int[maxNumRoads][4]; //[4],[4]
	endLanesID = new int[maxNumRoads][4];
    ...
    public boolean createPathBetween(int dir1, int num1,int dir2, int num2) {
	
	paths[dir1][pi[dir1]++] = new JunctionPath(
		 endLanesID[dir1][num1],startLanesID[dir2][num2],this,
		 parent.getLane(endLanesID[dir1][num1]).getEndingXCoord(),
		 parent.getLane(endLanesID[dir1][num1]).getEndingYCoord(),
		 parent.getLane(startLanesID[dir2][num2]).getStartingXCoord(),
		 parent.getLane(startLanesID[dir2][num2]).getStartingYCoord());
