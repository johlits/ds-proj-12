...
public class Junction implements XMLSerializable {
    ...
    // A Junction is an array of 9 points
    //          1----2----3
    //          |         |
    //          8    0    4
    //          |         |
	...
	System.out.println("In drawHandledJunction");
	...
	g2d.setColor(Color.black);
	g2d.drawString("J",x[0],y[0]);
	System.out.println("draw J, x[0],y[0]= "+x[0]+", "+y[0]);
	...
	switch (junctionType) {
	case SIGNALLED :    junctionType = GIVE_WAY;    break;
	case GIVE_WAY :     junctionType = BRIDGE_OVER; break;
	case BRIDGE_OVER :  junctionType = BRIDGE_UNDER;break;
	case BRIDGE_UNDER : junctionType = ALTSIGNALLED;break;
	case ALTSIGNALLED : junctionType = SIGNALLED;   break;
	}
    }
	...
	frame.addNotify(); 
	Image offscreen = frame.createImage(14,14);
	...
	System.out.println("in Junction loadSelf()");
